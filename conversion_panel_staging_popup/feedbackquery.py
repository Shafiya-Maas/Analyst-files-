...
def load_feedback_data(start_of_week=None, today=None):
    if start_of_week and today:
        # Use provided date range
        condition = f"AND l.b2b_log BETWEEN '{start_of_week}' AND '{today}'"
        limit_clause = ""  # No limit when using date range
    else:
        # Default to last 1000 records if no dates are provided
        condition = ""
...
def fetch_data_two(force_refresh=False, start_of_week=None, today=None):
